...
def test_format_diff_with_provided_diff(test_file1_r_json, test_file2_r_json):
...
def test_format_diff_with_provided_diff(test_file1_r_yaml, test_file2_r_yaml):
    # Создаем разницу между двумя конфигурациями
